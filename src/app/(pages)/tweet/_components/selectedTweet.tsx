    ...
    <AnimatePresence>
      {selectedTweet && (
        ...
        >
          ...
          {/* Tweet content box */}
          <motion.div
            className="bg-white h-screen w-5/6 flex flex-col overflow-hidden"
            onClick={(e) => e.stopPropagation()}
            ...
            <div className="flex-none p-3">
              <div className="flex items-center">
                <Image
                  ...
                  priority={true}
                />
                <h1 className="text-xl font-bold ml-3 cursor-pointer hover:underline">
                  {selectedTweet.user.username}
                </h1>
              </div>
              <p className="text-base mt-3">{selectedTweet.content}</p>
            </div>
            <div className="flex-none border-y border-gray-200">
